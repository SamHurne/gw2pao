...
namespace GW2PAO.ViewModels.Dungeon
{
    public class DungeonViewModel : NotifyPropertyChangedBase
    {
        ...
        public DungeonViewModel(GW2PAO.API.Data.Entities.Dungeon dungeon, IBrowserController browserController, DungeonUserData userData)
        {
