...
namespace GW2PAO.Models
{
    ...
    /// </summary>
    [Serializable]
    public class EventSettings : UserSettings<EventSettings>
    {
        /// <summary>
        /// Default logger
        /// </summary>
        ...
        /// </summary>
        public const string Filename = "EventSettings.xml";
        ...
        public override void EnableAutoSave()
        {
            ...
            this.PropertyChanged += (o, e) => EventSettings.SaveSettings(this, EventSettings.Filename);
            this.HiddenEvents.CollectionChanged += (o, e) => EventSettings.SaveSettings(this, EventSettings.Filename);
            this.EventsWithTreasureObtained.CollectionChanged += (o, e) => EventSettings.SaveSettings(this, EventSettings.Filename);
        }
    }
}
